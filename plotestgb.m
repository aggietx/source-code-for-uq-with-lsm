clear ;close all;
load data_gb_L12_K5.mat;id=1;rmst(id,:)=errest(1,1:Nit);rms(id,:)=errest(2,1:Nit);cc(id,:)=errest(3,1:Nit);
...
load data_gb_L24_K5.mat;id=2;rmst(id,:)=errest(1,1:Nit);rms(id,:)=errest(2,1:Nit);cc(id,:)=errest(3,1:Nit);
errsm=[mean(rmstimeexactsm(3:end));mean(rmsexactsm);mean(ccexactsm)];errsmL(:,id)=errsm;
freermst(id)=errest(1,end);freerms(id)=errest(2,end);freecc(id)=errest(3,end);

load data_gb_L36_K5.mat;id=3;rmst(id,:)=errest(1,1:Nit);rms(id,:)=errest(2,1:Nit);cc(id,:)=errest(3,1:Nit);
errsm=[mean(rmstimeexactsm(3:end));mean(rmsexactsm);mean(ccexactsm)];errsmL(:,id)=errsm;
freermst(id)=errest(1,end);freerms(id)=errest(2,end);freecc(id)=errest(3,end);

load data_gb_L48_K5.mat;id=4;rmst(id,:)=errest(1,1:Nit);rms(id,:)=errest(2,1:Nit);cc(id,:)=errest(3,1:Nit);
errsm=[mean(rmstimeexactsm(3:end));mean(rmsexactsm);mean(ccexactsm)];errsmL(:,id)=errsm;
freermst(id)=errest(1,end);freerms(id)=errest(2,end);freecc(id)=errest(3,end);

load data_gb_L60_K5.mat;id=5;rmst(id,:)=errest(1,1:Nit);rms(id,:)=errest(2,1:Nit);cc(id,:)=errest(3,1:Nit);
errsm=[mean(rmstimeexactsm(3:end));mean(rmsexactsm);mean(ccexactsm)];errsmL(:,id)=errsm;
freermst(id)=errest(1,end);freerms(id)=errest(2,end);freecc(id)=errest(3,end);
